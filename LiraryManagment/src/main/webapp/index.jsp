...
<html>
    ...
    <body>
        ...
        <form class="box"  onsubmit="return validateForm()" action="login">
           
            <h1>
               LogIn
            </h1>
     		<input type="text" name="u" value=""  placeholder="Enter Username" id="Username" >
     		<span id="username" style=color:red;></span>
     		
            <input type="password" name="p" value="" placeholder="Enter Password" id="password">
            ...
            <input id="buttontwo" type=button value="Sign In" class="buttontwo" onclick="location.href='Registration.jsp'" />
            <input id="buttonthree" type=submit value="Admin LogIn" class="buttontwo" onclick="location.href='Adminlogin.jsp'" />
        </form>
