...
function validateForm() {
  ...
  <form class="box"  onclick="return validateForm()" action="register" method="post">
            ...
            <span id="username" style=color:red;></span>
           	...
           	<input id="buttonone" type=submit value="Register"  onclick="location.href='Home.jsp'" />
           		<input id="buttontwo" type=submit value="Back"  onclick="location.href='index.jsp'" />
